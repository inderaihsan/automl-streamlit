...
st.write("""
This application allows you to upload geospatial data in Excel format and generate prediction using Machine Learning Model of Jabodetabek Region
...
if st.session_state["uploaded_file"] is not None:
    ...
    if st.button("Process Data"):
        ...
        if response.status_code == 200:
            ...
            file_name = f"prediction_jabodetabek_model_{timestamp}.xlsx"
