...
st.write("""
This application allows you to upload geospatial data in Excel format and generate prediction using Machine Learning Model of Maluku Region
...
if st.session_state["uploaded_file"] is not None:
    ...
    if st.button("Process Data"):
        ...
        response = requests.post(
            server_url + '/feat_gen/predict/maluku/',
